...
$packages["cdn.ssss.fun/VPN/js"] = (function() {
	var $pkg = {}, $init, Object, Error, sliceType, ptrType, ptrType$1, init;
	Object = $pkg.Object = $newType(0, $kindStruct, "js.Object", true, "cdn.ssss.fun/VPN/js", true, function(object_) {
		this.$val = this;
	...
	Error = $pkg.Error = $newType(0, $kindStruct, "js.Error", true, "cdn.ssss.fun/VPN/js", true, function(Object_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			return;
	...
	Object.init("cdn.ssss.fun/VPN/js", [{prop: "object", name: "object", anonymous: false, exported: false, typ: ptrType, tag: ""}]);
...
$packages["runtime"] = (function() {
	...
	js = $packages["cdn.ssss.fun/VPN/js"];
	...
	init = function() {
		var e, jsPkg;
		jsPkg = $packages[$externalize("cdn.ssss.fun/VPN/js", $String)];
...
$packages["main"] = (function() {
	...
	main = function() {
		...
		$global.document.title = $externalize("SSSS.FUN", $String);
